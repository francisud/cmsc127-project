	...
	<div id="log">
		...
		<div id="login-container" class="col-xs-6 col-md-4">
			<div class="page-header">
				<h3 id="heading">CREATE NEW PLAYLIST</h3>
			</div>
			
			<form action="submit_add_playlist.php" method="post">
			
				<div class="form-group">
					<div class="">
						<input type="text" class="form-control" placeholder="Playlist Name" required="required" name="playlist_name">
					</div>
				</div>							
